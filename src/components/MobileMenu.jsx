...
//         ${menuOpen ?"h-screen opacity-100 pointer-events-auto overflow-hidden":
    ...
    return (
      ...
      >
        ...
        <a
          href="#home"
          onClick={() => setMenuOpen(false)}
          className={`text-2xl font-semibold text-white my-4 transform transition-opacity duration-300 ${menuOpen ? "opacity-100" : "opacity-0"}`}
        >
          Home
        </a>
        <a
