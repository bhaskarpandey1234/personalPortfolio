    ...
    return(
        ...
        >
            ...
            <div className="text-center z-10 px-4">
                ...
                from-blue-500 t0-purple-600 leading-right">
                    Hi, I `&apos;`m Bhaskar
                </h1>
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    A Full-Stack Developer who loves crafting clean, scalable web applications. My goal is to build solutions that offers both exceptional performance and delightful user experince.
                </p>
